            ...
            Expanded(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Container(height: 8, width: 50, color: AppTheme.border,
                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(4))),
                    Container(height: 10, color: AppTheme.border,
                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(4))),
                    Container(height: 10, width: 160, color: AppTheme.border,
                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(4))),
                    Container(height: 12, width: 80, color: AppTheme.border,
                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(4))),
                  ],
                ),
              ),
